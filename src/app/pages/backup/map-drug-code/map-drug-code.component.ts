...
@Component({
  selector: 'app-map-drug-code',
  templateUrl: './map-drug-code.component.html',
  styleUrls: ['./map-drug-code.component.scss'],
})
export class MapDrugCodeComponent implements OnInit {
  INV_MD: Array<any> = [];
