...
export class AppointmentComponent implements OnInit {
  ...
  thDate: any = null;
  enDateNum: any;
  formattedDateNum = parseInt(moment(new Date()).format('YYYYMMDD'));

  listINV: Array<any> = [];
  listDispen: Array<any> = [];
  listAppoint: Array<any> = [];
  dataAppoint: any = null;
  @ViewChild('sortAppoint') sortAppoint!: MatSort;
  @ViewChild('paginatorAppoint') paginatorAppoint!: MatPaginator;
  displayAppoint: string[] = [];
  displayINV: string[] = [
    'DISP_DATE',
    'MED_CODE',
    'DISP_DEPT',
  ...
  selectUnit: any = this.units[0].value;
